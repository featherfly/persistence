 ...
 * <ul>
 * <li>说明：</li>
 * <li>1. 凡是参数以MAP形式传递的，其SQL语句必须是命名参数形式（update user set username =
 * :username）</li>
 * <li>2. 凡是参数以数组形式传递的，其SQL语句必须是问号占位形式（update user set username = ?）</li>
 * </ul>
 *
 * @author 钟冀
 */
public interface JdbcPersistence extends PersistenceBatch {
     ...
     * @return MAP列表
     */
    List<Map<String, Object>> findList(String sql, Pagination pagination, Map<String, Object> params);
     ...
     * @return 分页对象
     */
    PaginationResults<Map<String, Object>> findPage(String sql, Pagination pagination, Map<String, Object> params);
     ...
     * @return 分页对象
     */
    <E> PaginationResults<E> findPage(String sql, Class<E> mappingType, Pagination pagination,
     ...
     * @return 分页对象
     */
    <E> PaginationResults<E> findPage(String sql, Class<E> mappingType, int start, int limit,
            Map<String, Object> params);
     ...
     * @return 对象列表
     */
    <E> List<E> findList(String sql, RowMapper<E> rowMapper, Pagination pagination, Map<String, Object> params);
     ...
     * @return 对象列表
     */
    <E> List<E> findList(String sql, RowMapper<E> rowMapper, Pagination pagination, Object[] params);
     ...
     * @return 对象列表
     */
    <E> List<E> findList(String sql, RowMapper<E> rowMapper, Pagination pagination, List<Object> params);
     ...
     * @return 对象列表
     */
    <E> List<E> findList(String sql, RowMapper<E> rowMapper, int start, int limit, Map<String, Object> params);
     ...
     * @return 对象列表
     */
    <E> List<E> findList(String sql, RowMapper<E> rowMapper, int start, int limit, Object[] params);
     ...
     * @return 对象列表
     */
    <E> List<E> findList(String sql, RowMapper<E> rowMapper, int start, int limit, List<Object> params);
     ...
     * @return 分页对象
     */
    <E> PaginationResults<E> findPage(String sql, RowMapper<E> rowMapper, int start, int limit,
            Map<String, Object> params);
     ...
     * @return 分页对象
     */
    <E> PaginationResults<E> findPage(String sql, RowMapper<E> rowMapper, int start, int limit, Object[] params);
     ...
     * @return 分页对象
     */
    <E> PaginationResults<E> findPage(String sql, RowMapper<E> rowMapper, int start, int limit, List<Object> params);
}